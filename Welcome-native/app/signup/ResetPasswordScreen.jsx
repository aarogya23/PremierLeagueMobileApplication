...
const ResetPasswordScreen = () => {
  ...
  const closeModal = () => {
    setShowModal(false);
    if (isSuccess) router.replace('/'); // Go back to login
  };

  const handleResetPassword = async () => {
    if (!otp || !newPassword) {
      openModal('Missing Fields', 'Please enter OTP and new password.');
      return;
    }
    ...
    try {
      ...
      openModal('Connection Error', error.message);
    } finally {
      setLoading(false);
    }
  };
